...
namespace UI.Areas.Admin.Controllers
{
	...
	public class Book_AuthorController : Controller
	{
		public async Task<IActionResult> Index(int page = 1)
		{
			...
			var searchResult = await new Book_AuthorBL().GetAsync(new Book_AuthorSearchParams
			{
				StartIndex = (page - 1) * objectsPerPage,
				ObjectsCount = objectsPerPage,
			});
			var viewModel = new SearchResultViewModel<BookAuthorModel>(BookAuthorModel.FromEntitiesList(searchResult.Objects), 

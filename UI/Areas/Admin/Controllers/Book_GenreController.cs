...
namespace UI.Areas.Admin.Controllers
{
	...
	public class Book_GenreController : Controller
	{
		public async Task<IActionResult> Index(int page = 1)
		{
			...
			var searchResult = await new Book_GenreBL().GetAsync(new Book_GenreSearchParams
			{
				StartIndex = (page - 1) * objectsPerPage,
				ObjectsCount = objectsPerPage,
			});
			var viewModel = new SearchResultViewModel<BookGenreModel>(BookGenreModel.FromEntitiesList(searchResult.Objects), 
